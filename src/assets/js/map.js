...
function load_map() {
	$('.australiaPath').css('fill', '#46AC35');
	/*
	let vladivostok = localStorage.getItem('vladivostok');
	let japon = localStorage.getItem('japon');
	let vietnam = localStorage.getItem('vietnam');
	let siberia = localStorage.getItem('siberia');
	let dudinka = localStorage.getItem('dudinka');
	let medio_oriente = localStorage.getItem('medio-oriente');
	let omsk = localStorage.getItem('omsk');
	let aral = localStorage.getItem('aral');
	let china = localStorage.getItem('china');
	let india = localStorage.getItem('india');
	let tchita = localStorage.getItem('tchita');
	let mongolia = localStorage.getItem('mongolia');
	let alaska = localStorage.getItem('alaska');
	let mackenzie = localStorage.getItem('mackenzie');
	let vancouver = localStorage.getItem('vancouver');
	let groenlandia = localStorage.getItem('groenlandia');
	let nueva_york = localStorage.getItem('nueva-york');
	let california = localStorage.getItem('california');
	let ottawa = localStorage.getItem('ottawa');
	let labrador = localStorage.getItem('labrador');
	let mexico = localStorage.getItem('mexico');
	let chile_bolivia_peru_ecuador = localStorage.getItem('chile-bolivia-peru-ecuador');
	let argentina_paraguay_uruguay = localStorage.getItem('argentina-paraguay-uruguay');
	let brasil = localStorage.getItem('brasil');
	let colombia_venezuela = localStorage.getItem('colombia-venezuela');
	let nueva_guinea = localStorage.getItem('nueva-guinea');
	let borneo = localStorage.getItem('borneo');
	let sumatra = localStorage.getItem('sumatra');
	let australia = JSON.parse(localStorage.getItem('australia'));
	let inglaterra = localStorage.getItem('inglaterra');
	let moscu = localStorage.getItem('moscu');
	let suecia = localStorage.getItem('suecia');
	let islandia = localStorage.getItem('islandia');
	let alemania = localStorage.getItem('alemania');
	let espana_francia_italia = localStorage.getItem('espana-francia-italia');
	let polonia_yugoeslavia = localStorage.getItem('polonia-yugoeslavia');
	let sudan = localStorage.getItem('sudan');
	let el_congo = localStorage.getItem('el-congo');
	let africa_del_sur = localStorage.getItem('africa-del-sur');
	let argelia_nigeria = localStorage.getItem('argelia-nigeria');
	let madagascar = localStorage.getItem('madagascar');
	let egipto = localStorage.getItem('egipto');
	$('#vladivostokPath').css('color', vladivostok.army.color);
	$('#japonPath').css('color', japon.army.color);
	$('#vietnamPath').css('color', vietnam.army.color);
	$('#siberiaPath').css('color', siberia.army.color);
	$('#dudinkaPath').css('color', dudinka.army.color);
	$('#medio-orientePath').css('color', medio-oriente.army.color);
	$('#omskPath').css('color', omsk.army.color);
	$('#aralPath').css('color', aral.army.color);
	$('#chinaPath').css('color', china.army.color);
	$('#indiaPath').css('color', india.army.color);
	$('#tchitaPath').css('color', tchita.army.color);
	$('#mongoliaPath').css('color', mongolia.army.color);
	$('#alaskaPath').css('color', alaska.army.color);
	$('#mackenziePath').css('color', mackenzie.army.color);
	$('#vancouverPath').css('color', vancouver.army.color);
	$('#groenlandiaPath').css('color', groenlandia.army.color);
	$('#nueva-yorkPath').css('color', nueva-york.army.color);
	$('#californiaPath').css('color', california.army.color);
	$('#ottawaPath').css('color', ottawa.army.color);
	$('#labradorPath').css('color', labrador.army.color);
	$('#mexicoPath').css('color', mexico.army.color);
	$('#chile-bolivia-peru-ecuadorPath').css('color', chile-bolivia-peru-ecuador.army.color);
	$('#argentina-paraguay-uruguayPath').css('color', argentina-paraguay-uruguay.army.color);
	$('#brasilPath').css('color', brasil.army.color);
	$('#colombia-venezuelaPath').css('color', colombia-venezuela.army.color);
	$('#nueva-guineaPath').css('color', nueva-guinea.army.color);
	$('#borneoPath').css('color', borneo.army.color);
	$('#sumatraPath').css('color', sumatra.army.color);
	$('.australiaPath').css('fill', australia.army.color );
	$('#inglaterraPath').css('color', inglaterra.army.color);
	$('#moscuPath').css('color', moscu.army.color);
	$('#sueciaPath').css('color', suecia.army.color);
	$('#islandiaPath').css('color', islandia.army.color);
	$('#alemaniaPath').css('color', alemania.army.color);
	$('#espana-francia-italiaPath').css('color', espana-francia-italia.army.color);
	$('#polonia-yugoeslaviaPath').css('color', polonia-yugoeslavia.army.color);
	$('#sudanPath').css('color', sudan.army.color);
	$('#el-congoPath').css('color', el-congo.army.color);
	$('#africa-del-surPath').css('color', africa-del-sur.army.color);
	$('#argelia-nigeriaPath').css('color', argelia-nigeria.army.color);
	$('#madagascarPath').css('color', madagascar.army.color);
	$('#egiptoPath').css('color', egipto.army.color);
	$('.australiaPath').css('fill', '#46AC35');
*/
}
...
$(function () {
	...
	$('#polonia-yugoeslaviaClick').click(function () {   //Para agregar otro territorio copiar toda la función y cambiar
		let polonia_yugoeslavia = JSON.parse(localStorage.getItem('polonia_yugoeslavia'));
